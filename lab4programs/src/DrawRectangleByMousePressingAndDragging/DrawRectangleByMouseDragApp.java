package DrawRectangleByMousePressingAndDragging;
...
public class DrawRectangleByMouseDragApp extends JFrame {

    DrawRectangleByMouseDragGLEventListener listener = new DrawRectangleByMouseDragGLEventListener();
    static GLCanvas glcanvas = null;

    public static void main(String[] args) {
        final DrawRectangleByMouseDragApp app = new DrawRectangleByMouseDragApp();
        app.setVisible(true);
        glcanvas.requestFocusInWindow();
    }

    public DrawRectangleByMouseDragApp() {
        super("Draw Rectangle By Mouse Drag Application");
...
class DrawRectangleByMouseDragGLEventListener implements GLEventListener, MouseListener, MouseMotionListener, KeyListener {
