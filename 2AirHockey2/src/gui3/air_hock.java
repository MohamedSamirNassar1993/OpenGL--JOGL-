...
public class air_hock extends JFrame implements MouseMotionListener, MouseListener {//, KeyListener {
  ...
  static Animator anim;
    ...
    public air_hock() {
      ...
      try {
       URL soundURL = Main.class.getResource("C:\\Users\\hp\\Documents\\NetBeansProjects\\gui3\\gui3\\src\\gui3\\Air Hockey HD (mp3cut.net).wav");
...
//        throw new UnsupportedOperationException("hhh"); //To change body of generated methods, choose Tools | Templates.
   ...
   // int yp=220;     // y1 for player2
    ...
    int xp=0;      //x1 for computer player 
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        gl.glClear(GL.GL_COLOR_BUFFER_BIT);         
         ...
         // drawplayer(gl,0,0,1,1,0,0,xp,yp); //player2  
          ...
          drawplayer(gl,0,0,1,1,0,0,xp,yp);  // computer player
             computer_control(); 
          winner(gl);
