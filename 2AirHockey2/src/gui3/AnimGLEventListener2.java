...
public class AnimGLEventListener2 implements GLEventListener, KeyListener, MouseListener, MouseMotionListener {
    ...
    int maxWidth = 100;
    int maxHeight = 100;
    boolean started = true, up = false, down = false, vertical = true, paused = false, ended = false;
    // create two players
    // (1) AI, (2) human being
