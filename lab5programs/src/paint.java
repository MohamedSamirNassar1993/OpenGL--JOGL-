...
public class paint extends JFrame implements ActionListener {
    ...
    paintGLEventListener listener = new paintGLEventListener();
...
class paintGLEventListener implements GLEventListener, MouseListener, MouseMotionListener, KeyListener {
