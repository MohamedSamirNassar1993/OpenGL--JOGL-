...
public class paint5 extends JFrame implements ActionListener {

    paint5GLEventListener listener = new paint5GLEventListener();
...
class paint5GLEventListener implements GLEventListener, MouseListener, MouseMotionListener, KeyListener {
