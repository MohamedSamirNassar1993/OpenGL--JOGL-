...
public class keyboard extends javax.swing.JFrame implements KeyListener {

    Map<Integer, JButton> map = new HashMap<>();
//    JButton myB[] = new JButton[56];
    String strText = "";
    int keycode;
    ...
    private void initComponents() {
        ...
        btbackslash = new javax.swing.JButton();
        ...
        btbackslash.setBackground(java.awt.Color.white);
        btbackslash.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        btbackslash.setText("\\");
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(btbackslash, javax.swing.GroupLayout.PREFERRED_SIZE, 50, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
    ...
    private javax.swing.JButton btbackslash;
    ...
    protected final void Mohamed() {
        map.put(getKeyCode(btsymbol.getText()), btsymbol);
        map.put(getKeyCode(btTab.getText()), btTab);
        map.put(getKeyCode(btcaps.getText()), btcaps);
        map.put(getKeyCode(btshift.getText()), btshift);
        map.put(getKeyCode(btZ.getText()), btZ);
        map.put(getKeyCode(btA.getText()), btA);
        map.put(getKeyCode(btQ.getText()), btQ);
        map.put(getKeyCode(bt1.getText()), bt1);
        map.put(getKeyCode(bt2.getText()), bt2);
        map.put(getKeyCode(bt3.getText()), bt3);
        map.put(getKeyCode(bt4.getText()), bt4);
        map.put(getKeyCode(bt5.getText()), bt5);
        map.put(getKeyCode(bt6.getText()), bt6);
        map.put(getKeyCode(bt7.getText()), bt7);
        map.put(getKeyCode(bt8.getText()), bt8);
        map.put(getKeyCode(bt9.getText()), bt9);
        map.put(getKeyCode(bt0.getText()), bt0);
        map.put(getKeyCode(btnegative.getText()), btnegative);
        map.put(getKeyCode(btpositive.getText()), btpositive);
        map.put(getKeyCode(btbackspace.getText()), btbackspace);
        map.put(getKeyCode(btEnter.getText()), btEnter);
        map.put(getKeyCode(btrightinterval.getText()), btrightinterval);
        map.put(getKeyCode(btup.getText()), btup);
        map.put(getKeyCode(btright.getText()), btright);
        map.put(getKeyCode(btdown.getText()), btdown);
        map.put(getKeyCode(btleft.getText()), btleft);
        map.put(getKeyCode(btspace.getText()), btspace);
        map.put(getKeyCode(btC.getText()), btC);
        map.put(getKeyCode(btX.getText()), btX);
        map.put(getKeyCode(btV.getText()), btV);
        map.put(getKeyCode(btB.getText()), btB);
        map.put(getKeyCode(btN.getText()), btN);
        map.put(getKeyCode(btM.getText()), btM);
        map.put(getKeyCode(btcoma.getText()), btcoma);
        map.put(getKeyCode(btdot.getText()), btdot);
        map.put(getKeyCode(btquestionmark.getText()), btquestionmark);
        map.put(getKeyCode(btS.getText()), btS);
        map.put(getKeyCode(btW.getText()), btW);
        map.put(getKeyCode(btE.getText()), btE);
        map.put(getKeyCode(btD.getText()), btD);
        map.put(getKeyCode(btF.getText()), btF);
        map.put(getKeyCode(btR.getText()), btR);
        map.put(getKeyCode(btcomma.getText()), btcomma);
        map.put(getKeyCode(btleftinterval.getText()), btleftinterval);
        map.put(getKeyCode(btP.getText()), btP);
        map.put(getKeyCode(btL.getText()), btL);
        map.put(getKeyCode(btO.getText()), btO);
        map.put(getKeyCode(btI.getText()), btI);
        map.put(getKeyCode(btK.getText()), btK);
        map.put(getKeyCode(btJ.getText()), btJ);
        map.put(getKeyCode(btU.getText()), btU);
        map.put(getKeyCode(btY.getText()), btY);
        map.put(getKeyCode(btH.getText()), btH);
        map.put(getKeyCode(btG.getText()), btG);
        map.put(getKeyCode(btT.getText()), btT);
    }
}
