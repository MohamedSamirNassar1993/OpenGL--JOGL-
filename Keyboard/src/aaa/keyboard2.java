 ...
 * @author Moh
 */
public class keyboard2 extends javax.swing.JFrame implements KeyListener {
    ...
    private void initComponents() {
        ...
        map.put(getKeyCode(btsemicomma.getText()), btsemicomma);
        map.put(getKeyCode(btbachslash.getText()), btbachslash);
